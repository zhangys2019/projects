...
![Marat screenshot](https://raw.githubusercontent.com/JohnCoene/marat/master/assets/img/screenshot.png)

```{r intro}
div(class = "container-fluid",
    p(a(href="https://github.com/JohnCoene/marat", target = "_blank",
            HTML("<button class='bttn-unite bttn-lg bttn-default'><i class='fa fa-github' aria-hidden='true'></i> Get Started</button>"))))
```
...
```{r}
br()
a(href="https://johncoene.github.io/marat/", target = "_blank",
            HTML("<button class='bttn-unite bttn-lg bttn-danger'><i class='fa fa-newspaper-o' aria-hidden='true'></i> Live Demo</button>"))
```