...
Below I detail why I require each of the permissions. Note that I only perform **GET queries** and that therefore I cannot **POST** or **DELETE** any of your content; I can only **GET** data.
