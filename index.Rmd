...
div(class = "container-fluid",
    div(class = "row",
        thumbnail(title = "youTubeDataR",
          ...
          link.href = "packages/youTubeDataR/index.html",
          tag = "api",
          tag.class = "info"),
...
thumbnail(title = "chartist", 
          ...
          link.href = "htmlwidgets/chartist/index.html",
          tag = "visualisation",
          tag.class = "success"),
...
div(class = "container-fluid",
    div(class = "row",
        thumbnail(title = "uvcharts", 
          ...
          link.href = "htmlwidgets/uvcharts/index.html",
          tag = "visualisation",
          tag.class = "success"),
...
thumbnail(title = "bibler", 
          ...
          link.href = "packages/bibler/index.html",
          tag = "dataset",
          tag.class = "danger")))
...
thumbnail(title = "rodham", 
          ...
          link.href = "packages/rodham/index.html",
          tag = "api",
          tag.class = "info"),
...
div(class = "container-fluid",
    div(class = "row",
        thumbnail(title = "graphTweets", 
          ...
          link.href = "packages/graphTweets/index.html",
          tag = "visualisation",
          tag.class = "success"),
