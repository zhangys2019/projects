...
<div class="corner-ribbon top-right shadow red"><a href="tour" class = "white-text">Hire John</a></div>
        ...
        div(
          ...
          tags$ul(
            ...
            tags$li(
              ...
              a(
                class = "secondary-content",
                href = "http://github.com/JohnCoene/fiveline",
                target = "_blank",
                tags$i(
                  class = "material-icons grey-text text-darken-2",
                  "send"
    ...
    div(
      ...
      div(
        tags$a(
          ...
          img(
            class = "siema-img",
            src = "img/carousels/rodham_download.png"
          )
        )
      ),
      div(
