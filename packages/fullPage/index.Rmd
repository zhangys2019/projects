...
<div class="cont">
  <div class="rows">
    ...
    <div class="columns middles">
      <input type="text" value="http://shiny.john-coene.com/multiScroll">
    </div>
  ...
  <div class="contents video-container" style="height:600px;">
    <iframe src = "http://shiny.john-coene.com/multiScroll" width = "100%" frameborder="0" allowfullscreen></iframe>
  </div>
</div>')
```
