...
```{r button}
a(href="https://cran.r-project.org/web/packages/graphTweets/", target = "_blank",
            HTML("<button class='bttn-unite bttn-md bttn-danger'><i class='icon-rlogo'></i> CRAN Release</button>"))
```
