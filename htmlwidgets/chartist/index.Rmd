...
div(class = "row",
    div(class = "col-lg-4 col-mg-4",
        p(class = "text-center",
          a(href="https://github.com/JohnCoene/chartist/",
            HTML("<button class='bttn-unite bttn-lg bttn-primary'><i class='fa fa-github' aria-hidden='true'></i> Repository</button>")))),
    div(class = "col-lg-4 col-mg-4",
        p(class = "text-center",
          a(href="https://github.com/JohnCoene/chartist/issues",
            HTML("<button class='bttn-unite bttn-lg bttn-danger'><i class='fa fa-exclamation-circle' aria-hidden='true'></i> Issues</button>")))),
    div(class = "col-lg-4 col-mg-4",
        p(class = "text-center",
          a(href="https://github.com/JohnCoene/chartist/docs",
            HTML("<button class='bttn-unite bttn-lg bttn-success'><i class='fa fa-book' aria-hidden='true'></i> Docs</button>")))))
```
